...
try{
 ...
 if(Name==null){
      ...
      out.write("\t\n");
      out.write("\t\n");
      out.write("\t\t<!-- Space for post start-->\n");
      out.write("\t\t");
//check whether user login.
      ...
      out.write("\t\t\t\n");
      out.write("\t\t\t\t<!-- form for input post and file start -->\n");
      out.write("\t\t\t\t<form  class=\"form-signin\" method=\"post\" action=\"/InsaneNerds/Store_Timeline_Data\" enctype=\"multipart/form-data\">\n");
      ...
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t    \t\t</form> \n");
      out.write("\t    \t\t<!-- form for input post and file end --> \n");
      out.write("\t\t  \t</div>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t<div class=\"col-sm-4\"></div>\n");
      out.write("\t\t</div>\t\t\n");
      out.write("\t\t<!-- Space for post end-->\t\t\n");
      out.write("\t\t");
}
      out.write("\n");
      out.write("\t\t<br><br>\n");
...
for(String name:post.keySet()){ String key =name.toString();
      ...
      out.write(" \n");
      out.write("\t\t\n");
      out.write("\t\t<!-- Space for timeline start-->\t\t\n");
      out.write("\t\t<div class=\"container-fluid\">\n");
      out.write("\t\t\t<div class=\"col-sm-3\"></div>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t<!-- Post area at center start -->\n");
      out.write("\t\t\t<div class=\"col-sm-6\">\n");
      out.write("\t\t\t\t<div class=\"w3-card-4\" >\n");
      out.write("\t\t\t\t\t<div class=\"w3-container w3-card-4 col-sm-12\">\n");
      out.write("\t\t\t\t  \t\t\n");
      out.write("\t\t\t\t  \t\t<!-- Text of a post -->\n");
      out.write("\t\t\t\t  \t\t<p>");
      ...
      out.write("\t\t\t\t  \t\t\t<div class=\"col-sm-6\">\n");
      out.write("\t\t\t\t  \t\t\t\n");
      out.write("\t\t\t\t  \t\t\t\t<!-- form for showing like and unlike start -->\n");
      out.write("\t\t\t\t  \t\t\t\t<form action=\"/InsaneNerds/likes_dislikes\" method=\"post\">\n");
      out.write("\t\t\t\t\t\t\t\t\t");
//check like and unlike button shown to user who logged in.
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t\t\t<!-- form for showing like and unlike end -->\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<!-- form for showing comment button and inputcomment start -->\n");
...
if(emailid!=null){ //login user is able to comment
      ...
      out.write(" \n");
      out.write("\t\t\t\t\t\t\t\t  \t</form>\n");
      out.write("\t\t\t\t\t\t\t\t  \t<!-- form for showing comment button and inputcomment end -->\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t ");
...
//Show all comments of a post to all user who visit site. 
      ...
      out.write("\t\t\t\t  </div>\n");
      out.write("\t\t\t\t </div>\n");
      out.write("\t\t\t\t <!-- Post area at center end -->\n");
      out.write("\t\t\t\t <div class=\"col-sm-3\"></div>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<!-- Space for timeline end-->\n");
      out.write("\t\t<br><br><br> \t\t\n");
      out.write("\t\t");
 }
      out.write("\t\n");
